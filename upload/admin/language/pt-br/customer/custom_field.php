...
$_['help_sort_order']      = 'Use o valor negativo para contar de trás para frente, a partir do último campo do conjunto.';

// Erro
$_['error_permission']     = 'Aviso: Você não tem permissão para modificar os campos personalizados!';
$_['error_name']           = 'O nome do campo personalizado deve ter entre 1 e 128 caracteres!';
$_['error_type']           = 'Aviso: Valores de campo personalizado são necessários!';
