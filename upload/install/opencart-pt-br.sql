...
VALUES ('activity_customer_add', 'Adiciona novo registro de cliente no log de atividades.', 'catalog/model/account/customer.addCustomer/after', 'event/activity.addCustomer', 1),
        ('activity_customer_edit', 'Adiciona registro de edição de cliente no log de atividades.', 'catalog/model/account/customer.editCustomer/after', 'event/activity.editCustomer', 1),
        ('activity_customer_password', 'Adiciona registro de alteração de senha no log de atividades.', 'catalog/model/account/customer.editPassword/after', 'event/activity.editPassword', 1),
        ('activity_customer_forgotten', 'Adiciona registro de senha esquecida no log de atividades.', 'catalog/model/account/customer.addToken/after', 'event/activity.forgotten', 1),
        ('activity_customer_login', 'Adiciona registro de login de cliente no log de atividades.', 'catalog/model/account/customer.deleteLoginAttempts/after', 'event/activity.login', 1),
        ('activity_customer_transaction', 'Adiciona registro de transação de cliente no log de atividades.', 'catalog/model/account/customer.addTransaction/after', 'event/activity.addTransaction', 1),
        ('activity_address_add', 'Adiciona novo registro de endereço no log de atividades.', 'catalog/model/account/address.addAddress/after', 'event/activity.addAddress', 1),
        ('activity_address_edit', 'Adiciona registro de edição de endereço no log de atividades.', 'catalog/model/account/address.editAddress/after', 'event/activity.editAddress', 1),
        ('activity_address_delete', 'Adiciona registro de exclusão de endereço no log de atividades.', 'catalog/model/account/address.deleteAddress/after', 'event/activity.deleteAddress', 1),
        ('activity_affiliate_add', 'Adiciona novo registro de afiliado no log de atividades.', 'catalog/model/account/affiliate.addAffiliate/after', 'event/activity.addAffiliate', 1),
        ('activity_affiliate_edit', 'Adiciona registro de edição de afiliado no log de atividades.', 'catalog/model/account/affiliate.editAffiliate/after', 'event/activity.editAffiliate', 1),
        ('activity_order_add', 'Adiciona novo registro de pedido no log de atividades.', 'catalog/model/checkout/order.addHistory/before', 'event/activity.addHistory', 1),
        ('activity_return_add', 'Adiciona novo registro de devolução no log de atividades.', 'catalog/model/account/returns.addReturn/after', 'event/activity.addReturn', 1),
        ('mail_customer_add', 'Envia e-mail para clientes recém-registrados.', 'catalog/model/account/customer.addCustomer/after', 'mail/register', 1),
        ('mail_customer_alert', 'Envia e-mail de alerta para o proprietário da loja quando um novo cliente se registra.', 'catalog/model/account/customer.addCustomer/after', 'mail/register.alert', 1),
        ('mail_customer_transaction', 'Envia e-mail ao cliente quando o saldo de transações é atualizado.', 'catalog/model/account/customer.addTransaction/after', 'mail/transaction', 1),
        ('mail_customer_forgotten', 'Envia e-mail para clientes que esqueceram sua senha.', 'catalog/model/account/customer.addToken/after', 'mail/forgotten', 1),
        ('mail_customer_authorize', 'Envia código de login por e-mail para autorizar acesso de novo dispositivo.', 'catalog/controller/account/authorize.send/after', 'mail/authorize', 1),
        ('mail_customer_authorize_reset', 'Envia link de redefinição para usuários bloqueados após 3 tentativas erradas de login com código.', 'catalog/model/account/customer.addToken/after', 'mail/authorize.reset', 1),
        ('mail_affiliate_add', 'Envia e-mail para afiliados recém-registrados.', 'catalog/model/account/affiliate.addAffiliate/after', 'mail/affiliate', 1),
        ('mail_affiliate_alert', 'Envia e-mail para novos clientes.', 'catalog/model/account/affiliate.addAffiliate/after', 'mail/affiliate.alert', 1),
        ('mail_order', 'Envia e-mail para o cliente quando um pedido é realizado.', 'catalog/model/checkout/order.addHistory/before', 'mail/order', 1),
        ('mail_order_alert', 'Envia e-mail de alerta ao proprietário da loja quando um novo pedido é feito.', 'catalog/model/checkout/order.addHistory/before', 'mail/order.alert', 1),
        ('mail_gdpr', 'Envia e-mail para clientes que solicitaram exportação ou exclusão de dados (GDPR).', 'catalog/model/account/gdpr.addGdpr/after', 'mail/gdpr', 1),
        ('mail_gdpr_delete', 'Envia e-mail informando que os dados GDPR do cliente foram excluídos.', 'catalog/model/account/gdpr.editStatus/after', 'mail/gdpr.remove', 1),
        ('mail_review', 'Envia e-mail ao proprietário da loja quando uma nova avaliação é enviada.', 'catalog/model/catalog/review.addReview/after', 'mail/review', 1),
        ('mail_subscription', 'Envia e-mail ao proprietário da loja quando uma nova assinatura é criada.', 'catalog/model/checkout/subscription.addSubscription/after', 'mail/subscription', 1),
        ('statistics_review_add', 'Atualiza estatísticas de avaliações quando uma nova avaliação é adicionada.', 'catalog/model/catalog/review.addReview/after', 'event/statistics.addReview', 1),
        ('statistics_return_add', 'Atualiza estatísticas de devoluções quando uma nova devolução é adicionada.', 'catalog/model/account/returns.addReturn/after', 'event/statistics.addReturn', 1),
        ('statistics_return_delete', 'Atualiza estatísticas de devoluções quando uma devolução é excluída.', 'admin/model/sale/returns.deleteReturn/after', 'event/statistics.deleteReturn', 1),
        ('statistics_order_history', 'Atualiza estatísticas de status de pedido quando um pedido é atualizado.', 'catalog/model/checkout/order.addHistory/before', 'event/statistics.addHistory', 1),
        ('admin_currency_add', 'Atualiza moedas quando uma nova moeda é adicionada.', 'admin/model/localisation/currency.addCurrency/after', 'event/currency', 1),
        ('admin_currency_edit', 'Atualiza moedas quando uma moeda é editada.', 'admin/model/localisation/currency.editCurrency/after', 'event/currency', 1),
        ('admin_currency_setting', 'Atualiza moedas quando as configurações são salvas.', 'admin/model/setting/setting.editSetting/after', 'event/currency', 1),
        ('admin_mail_gdpr', 'Envia e-mail de aprovação ou rejeição para clientes que solicitaram exportação ou exclusão de dados (GDPR).', 'admin/model/customer/gdpr.editStatus/after', 'mail/gdpr', 1),
        ('admin_mail_affiliate_approve', 'Envia e-mail para o afiliado quando sua conta é aprovada.', 'admin/model/customer/customer_approval.approveAffiliate/after', 'mail/affiliate.approve', 1),
        ('admin_mail_affiliate_deny', 'Envia e-mail para o afiliado quando sua conta é rejeitada.', 'admin/model/customer/customer_approval.denyAffiliate/after', 'mail/affiliate.deny', 1),
        ('admin_mail_customer_approve', 'Envia e-mail para o cliente quando sua conta é aprovada.', 'admin/model/customer/customer_approval.approveCustomer/after', 'mail/customer.approve', 1),
        ('admin_mail_customer_deny', 'Envia e-mail para o cliente quando sua conta é rejeitada.', 'admin/model/customer/customer_approval.denyCustomer/after', 'mail/customer.deny', 1),
        ('admin_mail_customer_transaction', 'Envia e-mail ao cliente quando seu saldo de transações é atualizado.', 'admin/model/customer/customer.addTransaction/after', 'mail/transaction', 1),
        ('admin_mail_reward', 'Envia e-mail ao cliente quando seu saldo de recompensas é atualizado.', 'admin/model/customer/customer.addReward/after', 'mail/reward', 1),
        ('admin_mail_return', 'Envia e-mail ao cliente quando o status de sua devolução é alterado.', 'admin/model/sale/returns.addHistory/after', 'mail/returns', 1),
        ('admin_mail_user_forgotten', 'Envia e-mail para usuários que esqueceram suas senhas.', 'admin/model/user/user.addToken/after', 'mail/forgotten', 1),
        ('admin_mail_user_authorize', 'Envia código de login por e-mail para autorizar acesso de novo dispositivo.', 'admin/controller/common/authorize.send/after', 'mail/authorize', 1),
        ('admin_mail_user_authorize_reset', 'Envia link de redefinição para usuários bloqueados após 3 tentativas erradas de login com código.', 'admin/model/user/user.addToken/after', 'mail/authorize.reset', 1);
...
VALUES (1, 'opencart'),
       ...
       (1, 'opencart/admin/language/pt-br'),
       (1, 'opencart/admin/language/pt-br/captcha'),
       (1, 'opencart/admin/language/pt-br/captcha/basic.php'),
       (1, 'opencart/admin/language/pt-br/currency'),
       (1, 'opencart/admin/language/pt-br/currency/ecb.php'),
       (1, 'opencart/admin/language/pt-br/currency/fixer.php'),
       (1, 'opencart/admin/language/pt-br/dashboard'),
       (1, 'opencart/admin/language/pt-br/dashboard/activity.php'),
       (1, 'opencart/admin/language/pt-br/dashboard/chart.php'),
       (1, 'opencart/admin/language/pt-br/dashboard/customer.php'),
       (1, 'opencart/admin/language/pt-br/dashboard/map.php'),
       (1, 'opencart/admin/language/pt-br/dashboard/online.php'),
       (1, 'opencart/admin/language/pt-br/dashboard/order.php'),
       (1, 'opencart/admin/language/pt-br/dashboard/recent.php'),
       (1, 'opencart/admin/language/pt-br/dashboard/sale.php'),
       (1, 'opencart/admin/language/pt-br/fraud'),
       (1, 'opencart/admin/language/pt-br/fraud/ip.php'),
       (1, 'opencart/admin/language/pt-br/module'),
       (1, 'opencart/admin/language/pt-br/module/account.php'),
       (1, 'opencart/admin/language/pt-br/module/banner.php'),
       (1, 'opencart/admin/language/pt-br/module/bestseller.php'),
       (1, 'opencart/admin/language/pt-br/module/category.php'),
       (1, 'opencart/admin/language/pt-br/module/featured.php'),
       (1, 'opencart/admin/language/pt-br/module/filter.php'),
       (1, 'opencart/admin/language/pt-br/module/html.php'),
       (1, 'opencart/admin/language/pt-br/module/information.php'),
       (1, 'opencart/admin/language/pt-br/module/latest.php'),
       (1, 'opencart/admin/language/pt-br/module/special.php'),
       (1, 'opencart/admin/language/pt-br/module/store.php'),
       (1, 'opencart/admin/language/pt-br/payment'),
       (1, 'opencart/admin/language/pt-br/payment/bank_transfer.php'),
       (1, 'opencart/admin/language/pt-br/payment/cheque.php'),
       (1, 'opencart/admin/language/pt-br/payment/cod.php'),
       (1, 'opencart/admin/language/pt-br/payment/free_checkout.php'),
       (1, 'opencart/admin/language/pt-br/report'),
       (1, 'opencart/admin/language/pt-br/report/customer.php'),
       (1, 'opencart/admin/language/pt-br/report/customer_activity.php'),
       (1, 'opencart/admin/language/pt-br/report/customer_order.php'),
       (1, 'opencart/admin/language/pt-br/report/customer_reward.php'),
       (1, 'opencart/admin/language/pt-br/report/customer_search.php'),
       (1, 'opencart/admin/language/pt-br/report/subscription.php'),
       (1, 'opencart/admin/language/pt-br/report/customer_transaction.php'),
       (1, 'opencart/admin/language/pt-br/report/marketing.php'),
       (1, 'opencart/admin/language/pt-br/report/product_purchased.php'),
       (1, 'opencart/admin/language/pt-br/report/product_viewed.php'),
       (1, 'opencart/admin/language/pt-br/report/sale_coupon.php'),
       (1, 'opencart/admin/language/pt-br/report/sale_order.php'),
       (1, 'opencart/admin/language/pt-br/report/sale_return.php'),
       (1, 'opencart/admin/language/pt-br/report/sale_shipping.php'),
       (1, 'opencart/admin/language/pt-br/report/sale_tax.php'),
       (1, 'opencart/admin/language/pt-br/shipping'),
       (1, 'opencart/admin/language/pt-br/shipping/flat.php'),
       (1, 'opencart/admin/language/pt-br/shipping/free.php'),
       (1, 'opencart/admin/language/pt-br/shipping/item.php'),
       (1, 'opencart/admin/language/pt-br/shipping/pickup.php'),
       (1, 'opencart/admin/language/pt-br/shipping/weight.php'),
       (1, 'opencart/admin/language/pt-br/theme'),
       (1, 'opencart/admin/language/pt-br/theme/basic.php'),
       (1, 'opencart/admin/language/pt-br/total'),
       (1, 'opencart/admin/language/pt-br/total/coupon.php'),
       (1, 'opencart/admin/language/pt-br/total/credit.php'),
       (1, 'opencart/admin/language/pt-br/total/handling.php'),
       (1, 'opencart/admin/language/pt-br/total/low_order_fee.php'),
       (1, 'opencart/admin/language/pt-br/total/reward.php'),
       (1, 'opencart/admin/language/pt-br/total/shipping.php'),
       (1, 'opencart/admin/language/pt-br/total/sub_total.php'),
       (1, 'opencart/admin/language/pt-br/total/tax.php'),
       (1, 'opencart/admin/language/pt-br/total/total.php'),
       ...
       (1, 'opencart/catalog/language/pt-br'),
       (1, 'opencart/catalog/language/pt-br/captcha'),
       (1, 'opencart/catalog/language/pt-br/captcha/basic.php'),
       (1, 'opencart/catalog/language/pt-br/module'),
       (1, 'opencart/catalog/language/pt-br/module/account.php'),
       (1, 'opencart/catalog/language/pt-br/module/bestseller.php'),
       (1, 'opencart/catalog/language/pt-br/module/category.php'),
       (1, 'opencart/catalog/language/pt-br/module/featured.php'),
       (1, 'opencart/catalog/language/pt-br/module/filter.php'),
       (1, 'opencart/catalog/language/pt-br/module/information.php'),
       (1, 'opencart/catalog/language/pt-br/module/latest.php'),
       (1, 'opencart/catalog/language/pt-br/module/special.php'),
       (1, 'opencart/catalog/language/pt-br/module/store.php'),
       (1, 'opencart/catalog/language/pt-br/payment'),
       (1, 'opencart/catalog/language/pt-br/payment/bank_transfer.php'),
       (1, 'opencart/catalog/language/pt-br/payment/cheque.php'),
       (1, 'opencart/catalog/language/pt-br/payment/cod.php'),
       (1, 'opencart/catalog/language/pt-br/payment/free_checkout.php'),
       (1, 'opencart/catalog/language/pt-br/shipping'),
       (1, 'opencart/catalog/language/pt-br/shipping/flat.php'),
       (1, 'opencart/catalog/language/pt-br/shipping/free.php'),
       (1, 'opencart/catalog/language/pt-br/shipping/item.php'),
       (1, 'opencart/catalog/language/pt-br/shipping/pickup.php'),
       (1, 'opencart/catalog/language/pt-br/shipping/weight.php'),
       (1, 'opencart/catalog/language/pt-br/total'),
       (1, 'opencart/catalog/language/pt-br/total/coupon.php'),
       (1, 'opencart/catalog/language/pt-br/total/credit.php'),
       (1, 'opencart/catalog/language/pt-br/total/handling.php'),
       (1, 'opencart/catalog/language/pt-br/total/low_order_fee.php'),
       (1, 'opencart/catalog/language/pt-br/total/reward.php'),
       (1, 'opencart/catalog/language/pt-br/total/shipping.php'),
       (1, 'opencart/catalog/language/pt-br/total/sub_total.php'),
       (1, 'opencart/catalog/language/pt-br/total/total.php'),
...
VALUES (1, 1, 'Sobre', '&lt;p&gt;\r\n	Sobre&lt;/p&gt;\r\n', 'Sobre', '', ''),
       (2, 1, 'Termos &amp; Conditions', '&lt;p&gt;\r\n	Termos &amp;amp; Conditions&lt;/p&gt;\r\n', 'Termos &amp; Conditions', '', ''),
       (3, 1, 'Politicas de Privacidade', '&lt;p&gt;\r\n	Politicas de Privacidade&lt;/p&gt;\r\n', 'Politicas de Privacidade', '', ''),
       (4, 1, 'Informações de Entrega', '&lt;p&gt;\r\n	Informações de Entrega&lt;/p&gt;\r\n', 'Informações de Entrega', '', '');
...
VALUES (1, 'Portugês', 'pt-br', 'pt-br,pt', 1, 1);
...
VALUES (2, 1, 'Processando'),
       (3, 1, 'Enviado'),
       (7, 1, 'Cancelado'),
       (5, 1, 'Concluído'),
       (8, 1, 'Negado'),
       (9, 1, 'Estorno Cancelado'),
       (10, 1, 'Falhou'),
       (11, 1, 'Reembolsado'),
       (12, 1, 'Estornado'),
       (13, 1, 'Chargeback'),
...
-- Dados para a tabela `oc_return_reason`
INSERT INTO `oc_return_reason` (`return_reason_id`, `language_id`, `name`)
VALUES 
(1, 1, 'Defeito na chegada'),
(2, 1, 'Recebi o item errado'),
(3, 1, 'Erro no pedido'),
(4, 1, 'Com defeito, por favor forneça detalhes'),
(5, 1, 'Outro, por favor forneça detalhes');

-- -----------------------------------------------------------

-- Dados para a tabela `oc_return_status`
...
VALUES (0, 'config', 'config_shared', '0', 0),
       ...
       (0, 'config', 'config_language_catalog', 'pt-br', 0),
       (0, 'config', 'config_language_admin', 'pt-br', 0),
